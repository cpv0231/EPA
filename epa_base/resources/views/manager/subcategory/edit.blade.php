			...
			<div class="row">
				<div class="col-md-4">
					<div id="categories-form"  class="panel panel-default">
						...
						<form id="categories-form" action="{{url('subcategories-update')}}" method="POST">
							...
							<select class="form-control input-sm" name="category_id" >
								...
								Subcategory
								<input type="text" name="subcategory_name" class="form-control" value="{{$row->subcategory_name}}"><br/>
